...
insert into tblAddress (seq, name, age, gender, address, regdate) values(seqAddress.nextVal, '홍길동', 20, 'm', '서울시 강남구 역삼동', default);

select * from tblAddress;

--select count(*) form tblAddress;
